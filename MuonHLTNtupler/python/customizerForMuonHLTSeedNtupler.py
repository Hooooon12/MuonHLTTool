...
def customizerFuncForMuonHLTSeedNtupler(process, newProcessName = "MYHLT", doDYSkim = False, MvaVersion = "Run3v0"):
    ...
    process.seedNtupler.mvaFileHltIter2IterL3MuonPixelSeeds_B                      = cms.FileInPath("HLTrigger/MuonHLTSeedMVAClassifier/data/%s_Barrel_hltIter2.xml" % MvaVersion)
    ...
    process.seedNtupler.mvaFileHltIter2IterL3FromL1MuonPixelSeeds_B                = cms.FileInPath("HLTrigger/MuonHLTSeedMVAClassifier/data/%s_Barrel_hltIter2FromL1.xml" % MvaVersion)
    ...
    process.seedNtupler.mvaFileHltIter2IterL3MuonPixelSeeds_E                      = cms.FileInPath("HLTrigger/MuonHLTSeedMVAClassifier/data/%s_Endcap_hltIter2.xml" % MvaVersion)
    ...
    process.seedNtupler.mvaFileHltIter2IterL3FromL1MuonPixelSeeds_E                = cms.FileInPath("HLTrigger/MuonHLTSeedMVAClassifier/data/%s_Endcap_hltIter2FromL1.xml" % MvaVersion)
